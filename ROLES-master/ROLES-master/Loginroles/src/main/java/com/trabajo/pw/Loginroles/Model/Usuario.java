...
public class Usuario {
	...
	public Usuario(String nombre, String apellido, String username, String password, Collection<Rol> roles, String placadelvehiculo) {
		super();
		this.nombre = nombre;
	...
	public Usuario(Long id, String nombre, String apellido, String username, String password, Collection<Rol> roles, String placadelvehiculo) {
		super();
		this.id = id;
		this.nombre = nombre;
		this.apellido = apellido;
